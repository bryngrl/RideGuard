...
import { KeyboardAvoidingWrapper } from '@/shared/components/ui/keyboard-avoiding-wrapper';
import Stepper from '@/shared/components/ui/stepper';
import { CustomTextInput } from '@/shared/components/ui/text-input';
import { BrandColors, Spacing, Typography } from '@/shared/constants/theme.constants';
    ...
    <KeyboardAvoidingWrapper>
      <View style={styles.container}>
        ...
        <View style={styles.headerContainer}>
          ...
          <Text style={[Typography.body, { color: theme.textMuted, marginTop: Spacing.three }]}>
            Let's get started.
          </Text>
        </View>
