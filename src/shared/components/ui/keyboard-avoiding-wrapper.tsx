...
import { MaxContentWidth, Spacing } from '@/shared/constants/theme.constants';
...
export function KeyboardAvoidingWrapper({
  ...
  const content = <View style={[styles.innerContainer, contentContainerStyle]}>{children}</View>;
